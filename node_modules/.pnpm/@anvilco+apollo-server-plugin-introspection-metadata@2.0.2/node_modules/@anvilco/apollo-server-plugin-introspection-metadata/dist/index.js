...
const addMetadata = ({
  ...
  const {
    types = []
  } = (response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.__schema) || (response === null || response === void 0 ? void 0 : response.__schema) || {};
  ...
  function augmentArg({
    ...
    const argMetadata = (0, _lodash2.default)(argsMetadataForName, metadataSourceKey);
